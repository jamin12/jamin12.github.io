---
title: Kubernetes의 구조와 전체 흐름
date: 2025-05-30
tags: [k8s, control-plane, architecture]
summary: 선언한 상태를 컴포넌트들이 watch로 감지해 맞춰 가는 구조와 kubectl apply 이후 Pod가 뜨기까지의 흐름
order: 1
---
## Kubernetes의 기본 철학
...
- **의존성은 최소화**하고 동작은 분산하여 장애 전파를 방지하고 유지보수를 쉽게 합니다
...
2. kube-apiserver가 요청을 수신하고 etcd에 상태 저장
