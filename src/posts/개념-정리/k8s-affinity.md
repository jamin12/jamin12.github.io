---
title: Affinity와 Anti-affinity
date: 2025-06-29
tags: [k8s, scheduling, affinity]
summary: Node Affinity, Pod Affinity, Pod Anti-affinity로 파드를 어디에 붙이고 어디서 떨어뜨릴지 정하는 방법
order: 30
---
쿠버네티스에서는 파드를 특정 노드나 다른 파드와의 관계에 따라 유연하게 배치할 수 있는 기능을 제공합니다. 이때 사용하는 중요한 두 가지 개념이 바로 **Affinity**와 **Anti-affinity**입니다.
