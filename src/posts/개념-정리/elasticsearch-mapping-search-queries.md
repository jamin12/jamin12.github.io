...
![text vs keyword 저장 방식 비교](./images/09-text-vs-keyword.png)
...
![match vs term 쿼리 비교](./images/14-match-vs-term.png)
...
![bool 쿼리 구조](./images/10-bool-query-structure.png)
...
![should 적용 전후 비교](./images/11-should-comparison.png)
