---
title: ClusterIP와 Headless Service
date: 2025-06-24
tags: [k8s, networking, service, statefulset]
summary: 가상 IP 하나로 라우팅하는 ClusterIP와 파드별 IP를 그대로 돌려주는 Headless Service를 MySQL 구성 예로 비교
order: 19
---
