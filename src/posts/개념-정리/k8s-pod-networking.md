...
summary: CNI가 Pod에 IP를 주고 kube-proxy와 CoreDNS가 Service 통신을 잇는 구조, 그리고 Docker 단독 컨테이너와의 차이
order: 4
---
...
- `Service: frontend` 뒤에 `Pod A`, `Pod B`, `Pod C`가 있을 때
