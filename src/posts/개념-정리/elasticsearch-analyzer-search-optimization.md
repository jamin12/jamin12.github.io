...
![역인덱스 구조](./images/00-inverted-index.png)
...
![Score 계산의 3가지 요소](./images/00-score.png)
...
![Analyzer Pipeline](./images/01-analyzer-pipeline.png)
...
![lowercase Token Filter](./images/02-lowercase.png)
...
![html_strip Character Filter](./images/03-html-strip.png)
...
![stop + stemmer Token Filter](./images/04-stop-stemmer.png)
...
![synonym Token Filter](./images/05-synonym.png)
