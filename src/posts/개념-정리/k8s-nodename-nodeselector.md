---
title: nodeName과 nodeSelector
date: 2025-06-29
tags: [k8s, scheduling, node]
summary: 스케줄러를 우회하는 nodeName과 노드 레이블로 조건을 거는 nodeSelector
order: 29
---
...
## nodeSelector로 특정 조건을 만족하는 노드에 배치하기
