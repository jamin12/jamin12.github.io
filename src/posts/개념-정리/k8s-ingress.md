...
summary: 하나의 진입점에서 호스트와 경로 기준으로 여러 Service에 HTTP 트래픽을 나눠 주는 Ingress와 Ingress Controller
order: 21
---
...
2. **외부 트래픽이 Ingress Controller로 진입**
...
![Ingress 동작 구조](./images/k8s-20250622230256.png)
