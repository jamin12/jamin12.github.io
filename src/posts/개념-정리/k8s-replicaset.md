...
title: ReplicaSet
date: 2025-06-24
tags: [k8s, workload, replicaset]
summary: 파드 개수를 일정하게 유지하는 ReplicaSet과, 이를 감싸 배포 기능을 더한 Deployment의 관계
order: 9
---
...
![Deployment, ReplicaSet, Pod의 관계](./images/k8s-20250622142136.png)
