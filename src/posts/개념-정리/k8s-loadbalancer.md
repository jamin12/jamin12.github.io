...
summary: 클라우드 로드밸런서를 자동으로 붙이는 LoadBalancer 타입과 온프레미스에서의 대안
order: 17
---
...
4. 로드밸런서는 자동으로 클러스터 내부의 **NodePort 서비스**로 트래픽을 분배하므로, 파드가 어느 노드에 있든 외부에서 한 번에 접근 가능

![LoadBalancer 트래픽 흐름](./images/k8s-20250622155106.png)
